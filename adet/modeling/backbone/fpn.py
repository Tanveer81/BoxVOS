...
from .motion_resnet import build_motion_resnet_backbone
...
def build_fcos_resnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    ...
    elif cfg['motion_resnet'] or cfg['similarity_map_net']: #inject motion into backbone
        bottom_up = build_motion_resnet_backbone(cfg, input_shape)
    else:
